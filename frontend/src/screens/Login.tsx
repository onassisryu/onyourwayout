...
import {Text, TextInput, View, Keyboard, TouchableWithoutFeedback, Image} from 'react-native';
    ...
    <Container>  
      <StyledText style={css`
        ...
        `}>
          ...
          <Image source={require('../../assets/icons/login_NAVER.png')} style={css`
          margin-right:15px;
          margin-left:15px;`}/>
