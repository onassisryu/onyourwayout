...
// 배경 
const NotificationBar = styled(GlobalContainer)`
...
const NotificationBottom = styled(GlobalContainer)`
...
// 탭 컨테이너 스타일 정의
const TabsContainer = styled(GlobalContainer)`
  flex-direction: row;
...
// 카드 스타일 정의
const Card = styled(GlobalContainer)`
  position: absolute;
  right: 35px;
  left: 35px;
  align-items: center;
...
const CardComponent = styled(GlobalContainer)`
  flex-direction: row;
